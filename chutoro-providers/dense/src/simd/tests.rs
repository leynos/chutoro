...
#[rstest]
#[case(dispatch::EuclideanBackend::Scalar, 2, false)]
#[case(dispatch::EuclideanBackend::Avx2, 1, false)]
#[case(dispatch::EuclideanBackend::Avx512, 1, false)]
#[case(dispatch::EuclideanBackend::Neon, 1, false)]
#[case(dispatch::EuclideanBackend::Avx2, 2, true)]
#[case(dispatch::EuclideanBackend::Avx512, 2, true)]
#[case(dispatch::EuclideanBackend::Neon, 2, true)]
...
fn query_points_kernel_canonicalizes_non_finite_results_to_nan(
    ...
    let query = row_slice(matrix, RowIndex::new(0))?;
...
#[test]
fn avx2_entrypoint_canonicalizes_non_finite_to_nan_when_available() {
    if !std::arch::is_x86_feature_detected!("avx2") {
        return;
    }
...
#[test]
fn avx512_entrypoint_canonicalizes_non_finite_to_nan_when_available() {
    if !std::arch::is_x86_feature_detected!("avx512f") {
        return;
    }
